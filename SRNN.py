...
embedding_layer = Embedding(MAX_NUM_WORDS + 1, EMBEDDING_DIM, weights=[embedding_matrix], input_length=MAX_LEN // 64,
							trainable=True)
...
savebestmodel = 'save_model/SRNN(8,2)_yelp2013.h5py'
